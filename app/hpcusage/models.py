...
class Job(Base):
    ...
    id: Mapped[int] = mapped_column(BigInteger, primary_key=True)
    cluster_id: Mapped[int] = mapped_column(ForeignKey("clusters.id"), nullable=False)
    job_id_raw: Mapped[str] = mapped_column(String(64), nullable=False)
    ...
    account: Mapped[str] = mapped_column(String(128), nullable=False, default="")
...
class DailyUsage(Base):
    ...
    partition: Mapped[str] = mapped_column(String(64), primary_key=True)
    qos: Mapped[str] = mapped_column(String(64), primary_key=True)
